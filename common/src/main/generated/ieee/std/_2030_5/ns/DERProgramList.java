 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DERProgram" type="{urn:ieee:std:2030.5:ns}DERProgram" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
    ...
    extends SubscribableList
{
    ...
    protected List<DERProgram> derProgram;
     ...
     * 
     */
    public List<DERProgram> getDERProgram() {
        if (derProgram == null) {
