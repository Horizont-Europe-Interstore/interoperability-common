 ...
 *         &lt;element name="durationRequested" type="{urn:ieee:std:2030.5:ns}UInt16" minOccurs="0"/&gt;
 *         &lt;element name="energyRequested" type="{urn:ieee:std:2030.5:ns}SignedRealEnergy"/&gt;
 *         &lt;element name="intervalRequested" type="{urn:ieee:std:2030.5:ns}DateTimeInterval"/&gt;
 *         &lt;element name="powerRequested" type="{urn:ieee:std:2030.5:ns}ActivePower"/&gt;
 *         &lt;element name="RequestStatus" type="{urn:ieee:std:2030.5:ns}RequestStatus"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
