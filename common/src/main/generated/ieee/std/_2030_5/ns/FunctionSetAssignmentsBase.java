 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CustomerAccountListLink" type="{urn:ieee:std:2030.5:ns}CustomerAccountListLink" minOccurs="0"/&gt;
 *         &lt;element name="DemandResponseProgramListLink" type="{urn:ieee:std:2030.5:ns}DemandResponseProgramListLink" minOccurs="0"/&gt;
 *         &lt;element name="DERProgramListLink" type="{urn:ieee:std:2030.5:ns}DERProgramListLink" minOccurs="0"/&gt;
 *         &lt;element name="FileListLink" type="{urn:ieee:std:2030.5:ns}FileListLink" minOccurs="0"/&gt;
 *         &lt;element name="MessagingProgramListLink" type="{urn:ieee:std:2030.5:ns}MessagingProgramListLink" minOccurs="0"/&gt;
 *         &lt;element name="PrepaymentListLink" type="{urn:ieee:std:2030.5:ns}PrepaymentListLink" minOccurs="0"/&gt;
 *         &lt;element name="ResponseSetListLink" type="{urn:ieee:std:2030.5:ns}ResponseSetListLink" minOccurs="0"/&gt;
 *         &lt;element name="TariffProfileListLink" type="{urn:ieee:std:2030.5:ns}TariffProfileListLink" minOccurs="0"/&gt;
 *         &lt;element name="TimeLink" type="{urn:ieee:std:2030.5:ns}TimeLink" minOccurs="0"/&gt;
 *         &lt;element name="UsagePointListLink" type="{urn:ieee:std:2030.5:ns}UsagePointListLink" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
