 ...
 *       &lt;sequence&gt;
 *         &lt;element name="chargingPowerNow" type="{urn:ieee:std:2030.5:ns}ActivePower"/&gt;
 *         &lt;element name="energyRequestNow" type="{urn:ieee:std:2030.5:ns}RealEnergy"/&gt;
 *         &lt;element name="maxForwardPower" type="{urn:ieee:std:2030.5:ns}ActivePower"/&gt;
 *         &lt;element name="minimumChargingDuration" type="{urn:ieee:std:2030.5:ns}UInt32"/&gt;
 *         &lt;element name="targetStateOfCharge" type="{urn:ieee:std:2030.5:ns}PerCent"/&gt;
 *         &lt;element name="timeChargeIsNeeded" type="{urn:ieee:std:2030.5:ns}TimeType"/&gt;
 *         &lt;element name="timeChargingStatusPEV" type="{urn:ieee:std:2030.5:ns}TimeType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
